...
<div class="form-group">
 ...
 <div class="form-group">
    <label>Alamat Sekolah</label>
     <input name="alamat" placeholder="Alamat Sekolah" value="<?= $sekolah->alamat ?>" class="form-control" />
 </div>
 ...
 <div class="form-group">
    <label>No Telpon</label>
     <input name="no_telpon" placeholder="No Telpon" value="<?= $sekolah->no_telpon?>" class="form-control" />
 </div>
 ...
 <div class="form-group">
    <label>Kondisi Sekolah</label>
     <input name="kondisi_sekolah" placeholder="Kondisi Sekolah" value="<?= $sekolah->kondisi_sekolah ?>" class="form-control" />
 </div>

 <div class="form-group">
    <label>Luas Bangunan</label>
     <input name="luas_bangunan" placeholder="Luas Bangunan" value="<?= $sekolah->luas_bangunan ?>" class="form-control" />
 </div>

 <div class="form-group">
    <label>Jumlah Siswa</label>
     <input name="jumlah_siswa" placeholder="Jumlah Siswa" value="<?= $sekolah->jumlah_siswa ?>" class="form-control" />
 </div>
